...
namespace Voxel
{
    public static class WorldDataHelper
    {
        ...
        public static void SetBlock(World worldReference, Vector3Int worldBlockPosition, VoxelType voxelType)
        {
        ...
        public static List<Vector3Int> SelectDataPositonsToCreate(WorldData worldData, List<Vector3Int> allChunkDataPositionsNeeded, Vector3Int playerPosition)
        {
