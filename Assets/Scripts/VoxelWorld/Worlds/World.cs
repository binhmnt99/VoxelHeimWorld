...
namespace Voxel
{
    public class World : MonoBehaviour
    {
        ...
        private void AddTreeLeafs(ChunkData chunkData)
        {
            ...
            {
                Chunk.SetBlock(chunkData, treeLeafes, VoxelType.TREE_LEAF);
            }
        }
        ...
        public bool SetBlock(RaycastHit hit, VoxelType voxelType)
        {
            ...
            WorldDataHelper.SetBlock(chunk.ChunkData.worldReference, pos, voxelType);
        ...
        public VoxelType GetBlockFromChunkCoordinates(ChunkData chunkData, int x, int y, int z)
        {
